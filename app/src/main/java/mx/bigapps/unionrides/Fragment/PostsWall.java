 ...
 */
public class PostsWall extends Fragment {
    static RecyclerView photo_recycle;

    static Photo_Adapter photo_adapter;
    ...
    public RecyclerView userPost;
    public UserPost_Adapter userPost_adapter;
    public ArrayList<UserPosts> userPostsArrayList;
    ...
    public int page = 0;
    public int flagvalue, flagvalue1, curSize;
    public LinearLayoutManager layoutManager;
    static TextView nofriends;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.postwall, container, false);
                                ...
                                if (page == 0) {
                                    ...
                                    try {
                                        ...
                                        if (userPostsArrayList.size() > 0) {
                                            ...
                                            Wall.swipeRefreshLayout.setRefreshing(false);
                                        } else {
                                            userPost.setVisibility(View.GONE);
                                            notfound.setVisibility(View.VISIBLE);
...
//							Toast.makeText(StringRequestActivity.this,error.toString(),Toast.LENGTH_LONG).show();
    ...
    private void showProgDialog(Context context) {
...
//							Toast.makeText(StringRequestActivity.this,error.toString(),Toast.LENGTH_LONG).show();
    ...
    public void showProgDialog2(Context context) {
        // TODO Auto-generated method stub
        progress_dialog = null;
        try {
            if (Build.VERSION.SDK_INT >= 11) {
    ...
    public void getPostviews() {
        userPost = (RecyclerView) rootView.findViewById(R.id.userPost);
        layoutManager = new LinearLayoutManager(getActivity());
        userPost.setLayoutManager(layoutManager);
    }

    public void showAllPostsscroll(final Context context, final int page) {
...
//							Toast.makeText(StringRequestActivity.this,error.toString(),Toast.LENGTH_LONG).show();
    ...
    public Posts newInstance(ArrayList<UserPosts> userPostsArrayList) {
