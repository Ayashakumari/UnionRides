...
import mx.bigapps.unionrides.Adapter.Allevents_Adapter;
 ...
 */
public class Allevnts extends Fragment {
    static RecyclerView photo_recycle;
    LinearLayoutManager layoutManager;
    static Allevents_Adapter allevents_adapter;
    ArrayList photolist;
    CircleImageView profile_img;
    private ProgressDialog progress_dialog;
    private final int SHOW_PROG_DIALOG = 0, HIDE_PROG_DIALOG = 1, LOAD_QUESTION_SUCCESS = 2;
    private String progress_dialog_msg = "", tag_string_req = "string_req";
    static AlleventData alleventData;
    static ArrayList<AlleventData> alleventDataArrayList;
                        ...
                        try {
                            ...
                            if (jsonArray.length() == 0) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    /*JSONArray jsonArray1 = jarray.getJSONArray("event_image_thumbs");
                                    ...
                                    /*alleventDataArrayList.add(alleventData);
                                    allevents_adapter = new Allevents_Adapter(getActivity(), alleventDataArrayList);
                                    photo_recycle.setAdapter(allevents_adapter);
                                ...
                                if (page == 0) {
                                    ...
                                    allevents_adapter.notifyDataSetChanged();
                                } else {

                                    curSize = alleventDataArrayList.size();
                                    alleventDataArrayList.addAll(curSize, list);
                                    allevents_adapter.notifyItemInserted(curSize);
                                    allevents_adapter.notifyItemRangeChanged(curSize, alleventDataArrayList.size());
                                    allevents_adapter.notifyDataSetChanged();
                                }
                        ...
                        try {
                            ...
                            if (jsonArray.length() == 0) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    String image320 = jobj.getString("320_320");
                                    String user_profile_status;
                                    if (helper.status.equals("otherprofile_event")) {
                                        user_profile_status = "1";
                                    } else {
                                    ...
                                    alleventData = new AlleventData(event_id, user_id, event_title, start_date, start_time, end_date, end_time, description, profiletype, event_location, event_image, latitude, longitude, date_added, posted_by, posted_time, profile_image, my_event, event_join_status, user_profile_status, eventjoinCount, image320);
                                    alleventDataArrayList.add(alleventData);
                                    allevents_adapter = new Allevents_Adapter(context, alleventDataArrayList);
                                    photo_recycle.setAdapter(allevents_adapter);
                                    photo_recycle.setVisibility(View.VISIBLE);
                                    //nofriends.setVisibility(View.GONE);
                                }
