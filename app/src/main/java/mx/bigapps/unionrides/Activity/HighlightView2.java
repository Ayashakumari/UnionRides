...
class HighlightView2 {
    ...
    public HighlightView2(View context) {
        viewContext = context;
    ...
    private void initStyles(Context context) {
        ...
        context.getTheme().resolveAttribute(com.soundcloud.android.crop.R.attr.cropImageStyle, outValue, true);
        TypedArray attributes = context.obtainStyledAttributes(outValue.resourceId, com.soundcloud.android.crop.R.styleable.CropImageView);
        try {
            showThirds = attributes.getBoolean(com.soundcloud.android.crop.R.styleable.CropImageView_showThirds, false);
            showCircle = attributes.getBoolean(com.soundcloud.android.crop.R.styleable.CropImageView_showCircle, false);
            highlightColor = attributes.getColor(com.soundcloud.android.crop.R.styleable.CropImageView_highlightColor,
                    DEFAULT_HIGHLIGHT_COLOR);
            handleMode = HandleMode.values()[attributes.getInt(com.soundcloud.android.crop.R.styleable.CropImageView_showHandles, 0)];
        } finally {
            attributes.recycle();
        }
    }
