...
public class Crop2 {
     ...
     */
    public static Crop2 of(Uri source, Uri destination) {
        return new Crop2(source, destination);
    }

    private Crop2(Uri source, Uri destination) {
     ...
     * @param y Aspect Y
     */
    public Crop2 withAspect(int x, int y) {
     ...
     */
    public Crop2 withMaxSize(int width, int height) {
     ...
     */
    public Crop2 asPng(boolean asPng) {
    ...
    private static void showImagePickerError(Context context) {
        Toast.makeText(context.getApplicationContext(), com.soundcloud.android.crop.R.string.crop__pick_error, Toast.LENGTH_SHORT).show();
    }
