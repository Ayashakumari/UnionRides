...
public class GPSTracker extends Service implements LocationListener {
    ...
    public GPSTracker(Context context, String abc) {
    ...
    public void requestPermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale((Activity) mContext, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            // Toast.makeText(mContext, "Write External Storage permission allows us to do store images. Please allow this permission in App Settings.", Toast.LENGTH_LONG).show();
        } else {
    ...
    public void requestPermissionCamera() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale((Activity) mContext, Manifest.permission.CAMERA)) {
            ...
            // Toast.makeText(mContext, "Camera permission allows us to do capture images. Please allow this permission in App Settings.", Toast.LENGTH_LONG).show();
        } else {
