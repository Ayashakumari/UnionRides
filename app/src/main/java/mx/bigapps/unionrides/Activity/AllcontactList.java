...
import mx.bigapps.unionrides.Adapter.AllcontactAdapter;
...
public class AllcontactList extends Activity {
    ...
    static AllcontactAdapter networkPeople_adapter;
    ...
    protected void onCreate(Bundle savedIntancestate) {
        ...
        layoutManager = new LinearLayoutManager(AllcontactList.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // Recent_Chat.refreshRecentChat(AllcontactList.this);
                finish();
            }
        });
                ...
                if (!loading && (totalItemCount - visibleItemCount)
                    ...
                    try {
                        if (netWorkUserLists.size() < Integer.parseInt(total_count)) {
                            ...
                            Toast.makeText(AllcontactList.this,
    ...
    private void showProgDialog() {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 11) {
                progress_dialog = new ProgressDialog(AllcontactList.this, AlertDialog.THEME_HOLO_LIGHT);
            } else {
                progress_dialog = new ProgressDialog(AllcontactList.this);
            }
            progress_dialog.setMessage("loading");
            progress_dialog.setCancelable(false);
            progress_dialog.show();
                                ...
                                if (page == 0) {
                                    ...
                                    try {
                                        ...
                                        if (netWorkUserLists.size() > 0) {
                                            lvnetworkfan.setVisibility(View.VISIBLE);
                                            networkPeople_adapter = new AllcontactAdapter(AllcontactList.this, netWorkUserLists);
...
//							Toast.makeText(StringRequestActivity.this,error.toString(),Toast.LENGTH_LONG).show();
                            Toast.makeText(AllcontactList.this, "Time Out Error", Toast.LENGTH_LONG).show();
                        } else if (error instanceof AuthFailureError) {
                            Toast.makeText(AllcontactList.this, "Authentication Error", Toast.LENGTH_LONG).show();
                            //TODO
                        } else if (error instanceof ServerError) {
//							Toast.makeText(StringRequestActivity.this,error.toString(),Toast.LENGTH_LONG).show();
                            Toast.makeText(AllcontactList.this, "Server Error", Toast.LENGTH_LONG).show();
                            //TODO
                        } else if (error instanceof NetworkError) {
                            Toast.makeText(AllcontactList.this, "Network Error", Toast.LENGTH_LONG).show();
//							Toast.makeText(StringRequestActivity.this,error.toString(),Toast.LENGTH_LONG).show();
                            //TODO
...
//							Toast.makeText(StringRequestActivity.this,error.toString(),Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() {
               ...
               // params.put("other_user_id", PrefMangr.getInstance().getUserId());
                Log.d("Myfriendlist", params.toString());
                return params;
            }

        };

        RequestQueue requestQueue = Volley.newRequestQueue(AllcontactList.this);
