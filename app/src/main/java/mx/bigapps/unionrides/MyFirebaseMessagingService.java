...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public static String MESSAGE_ACTION2 = "com.ritesh.gcmchat";
    ...
    //	String image;
    Intent intentt = null;
    String from, invoice_id, grp_id, msg_time;
    ...
    String callid;
    private static final String APP_KEY = "1c00928b-f757-4d54-b937-816936b5bfed";
    private static final String APP_SECRET = "6uSx9TFZX0CtMOqzF+C5RQ==";
    private static final String ENVIRONMENT = "clientapi.sinch.com";
    String calltype, firstName;
    Context context;
    String video_thumb;
    String file_size;
    String file_type;
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        try {
            ...
            Map<String, String> mszdata = remoteMessage.getData();

            context = MyFirebaseMessagingService.this;
            String body = mszdata.get("body");
...
//						displayMessage_1(context, friend_id, time, message);
        ...
        /*	if (type.equals("Project Post Notification")) {
            ...
            String channelId = "com.unionrides";
            CharSequence channelName = "SAM";
