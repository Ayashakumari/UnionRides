...
public class Friendlist_Adapter extends RecyclerView.Adapter<Friendlist_Adapter.ItemViewHolder> {
    ...
    public Friendlist_Adapter(Context context, ArrayList<NetWorkUserList> employer_list) {
    ...
    public void onBindViewHolder(final ItemViewHolder viewHolder, final int position) {
        ...
        if (employer_list.get(position).getRequest_sent().equals("Add Friend")) {
            // viewHolder.clubimage.setVisibility(View.VISIBLE);
        ...
        viewHolder.btnaccpt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (employer_list.get(position).getRequest_sent().equals("Accept")) {
                ...
                if (employer_list.get(position).getRequest_sent().equals("Add Friend")) {
                    if (PrefMangr.getInstance().getUserId().equals(employer_list.get(position).getUser_id())) {
                        ...
                        alert.setMessage("You can't send friend request to yourself " + employer_list.get(position).getFullname());
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            //  FriendList.swipeRefreshLayout.setRefreshing(true);
