...
public class NetworkPeople_Adapter extends RecyclerView.Adapter<NetworkPeople_Adapter.ItemViewHolder> {
    ...
    public NetworkPeople_Adapter(Context context, ArrayList<NetWorkUserList> employer_list) {
    ...
    public void onBindViewHolder(final ItemViewHolder viewHolder, final int position) {
        ...
        if (employer_list.get(position).getuser_status().equals("Fan")) {
            viewHolder.btnaccpt.setText("UnFan");
            viewHolder.btnaccpt.setBackgroundResource(R.drawable.fanbtn);
            viewHolder.btnaccpt.setTextColor(Color.parseColor("#FFFFFF"));
        }
        if (employer_list.get(position).getRequest_sent().equals("Request_sent")) {
            viewHolder.btnaccpt.setText("Sent");
            viewHolder.btnaccpt.setBackgroundResource(R.drawable.fanbtn);
            viewHolder.btnaccpt.setTextColor(Color.parseColor("#FFFFFF"));
        }
        if (employer_list.get(position).getRequest_sent().equals("Following")) {
            viewHolder.btnaccpt.setText("Unfollow");
            viewHolder.btnaccpt.setBackgroundResource(R.drawable.fanbtn);
            viewHolder.btnaccpt.setTextColor(Color.parseColor("#FFFFFF"));
        }
        if (employer_list.get(position).getRequest_sent().equals("Accept") & employer_list.get(position).getType().equals("1")) {
            viewHolder.clubimage.setVisibility(View.VISIBLE);
            viewHolder.btnaccpt.setText("Accept");
            viewHolder.btnaccpt.setBackgroundResource(R.drawable.aceptbtn);
            viewHolder.btnaccpt.setTextColor(Color.parseColor("#000000"));
        ...
        if (employer_list.get(position).getUser_id().equals(PrefMangr.getInstance().getUserId())) {
            viewHolder.btnaccpt.setText("You");
            viewHolder.btnaccpt.setBackgroundColor(Color.parseColor("#FFFFFF"));
            viewHolder.btnaccpt.setTextColor(Color.parseColor("#000000"));
            viewHolder.btnaccpt.setEnabled(false);

        }
        viewHolder.btnaccpt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (employer_list.get(position).getType().equals("0") & employer_list.get(position).getuser_status().equals("Add Friend")) {
                    sendfriendRequest(employer_list.get(position).getUser_id());
                    viewHolder.btnaccpt.setText("Sent");
                    viewHolder.btnaccpt.setBackgroundResource(R.drawable.fanbtn);
                    viewHolder.btnaccpt.setTextColor(Color.parseColor("#FFFFFF"));
                }

                if (employer_list.get(position).getuser_status().equals("Fan") & employer_list.get(position).getType().equals("0")) {
                    ...
                    alert.setMessage("Do you want to unfan " + employer_list.get(position).getFullname());
                    ...
                    alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            try {
                                declinerequest(employer_list.get(position).getUser_id());
                                viewHolder.btnaccpt.setText("Request");
                                viewHolder.btnaccpt.setBackgroundResource(R.drawable.aceptbtn);
                                viewHolder.btnaccpt.setTextColor(Color.parseColor("#000000"));
                                dialog.dismiss();
                ...
                if (employer_list.get(position).getuser_status().equals("Fan") & employer_list.get(position).getType().equals("1")) {
                    //showAlertdecline("Do you want to unfriend  " + employer_list.get(position).getFullname(), employer_list.get(position).getUser_id(), position);
                    final AlertDialog.Builder alert;
                    if (Build.VERSION.SDK_INT >= 11) {
                        alert = new AlertDialog.Builder(context, AlertDialog.THEME_HOLO_LIGHT);
                    ...
                    alert.setMessage("Do you want to unfriend " + employer_list.get(position).getFullname());
                ...
                if (employer_list.get(position).getType().equals("1") & employer_list.get(position).getRequest_sent().equals("Follow")) {
                    Followuser(employer_list.get(position).getUser_id());
                    viewHolder.btnaccpt.setText("Unfollow");
                    viewHolder.btnaccpt.setBackgroundResource(R.drawable.fanbtn);
                    viewHolder.btnaccpt.setTextColor(Color.parseColor("#FFFFFF"));
                }
                if (employer_list.get(position).getRequest_sent().equals("Following") & employer_list.get(position).getType().equals("1")) {
                ...
                if (employer_list.get(position).getRequest_sent().equals("Accept") & employer_list.get(position).getType().equals("1")) {
                    ...
                    viewHolder.btnaccpt.setText("Fan");
                    viewHolder.btnaccpt.setBackgroundResource(R.drawable.fanbtn);
                    viewHolder.btnaccpt.setTextColor(Color.parseColor("#FFFFFF"));
                ...
                if (employer_list.get(position).getuser_status().equals("Fan") & employer_list.get(position).getType().equals("2")) {
                    //showAlertdecline("Do you want to unfriend  " + employer_list.get(position).getFullname(), employer_list.get(position).getUser_id(), position);
                    final AlertDialog.Builder alert;
                    if (Build.VERSION.SDK_INT >= 11) {
                        alert = new AlertDialog.Builder(context, AlertDialog.THEME_HOLO_LIGHT);
                ...
                if (employer_list.get(position).getType().equals("2") & employer_list.get(position).getRequest_sent().equals("Follow")) {
                    Followuser(employer_list.get(position).getUser_id());
                    viewHolder.btnaccpt.setText("Unfollow");
                    viewHolder.btnaccpt.setBackgroundResource(R.drawable.fanbtn);
                    viewHolder.btnaccpt.setTextColor(Color.parseColor("#FFFFFF"));
                }
                if (employer_list.get(position).getRequest_sent().equals("Following") & employer_list.get(position).getType().equals("2")) {
                    UnFollowuser(employer_list.get(position).getUser_id());
                    viewHolder.btnaccpt.setText("Follow");
                    viewHolder.btnaccpt.setBackgroundResource(R.drawable.aceptbtn);
                    viewHolder.btnaccpt.setTextColor(Color.parseColor("#000000"));
                }
                if (employer_list.get(position).getRequest_sent().equals("Accept") & employer_list.get(position).getType().equals("2")) {
                    UnFollowuser(employer_list.get(position).getUser_id());
                    viewHolder.btnaccpt.setText("Follow");
                    viewHolder.btnaccpt.setBackgroundResource(R.drawable.aceptbtn);
                    viewHolder.btnaccpt.setTextColor(Color.parseColor("#000000"));
