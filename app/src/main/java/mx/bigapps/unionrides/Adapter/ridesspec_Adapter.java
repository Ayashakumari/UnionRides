...
public class ridesspec_Adapter extends BaseAdapter{
    ...
    public ridesspec_Adapter(Context context, ArrayList<String> employer_list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.specrider, null);
        }
