...
public class Myspecification_Adapter extends RecyclerView.Adapter<Myspecification_Adapter.ItemViewHolder> {
    ...
    public Myspecification_Adapter(Context context, ArrayList<AlleventData> employer_list) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(employer_list.get(position).getEvent_image())) {
                Picasso.with(context)
                        .load(employer_list.get(position).getEvent_image())
                        .noFade()
                ...
                itemViewHolder.imgEvent.setBackgroundResource(R.drawable.userimages);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
