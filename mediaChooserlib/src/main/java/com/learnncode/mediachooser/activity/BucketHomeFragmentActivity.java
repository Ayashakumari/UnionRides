	...
	protected void onCreate(Bundle savedInstanceState) {
	  ...
	  headerBarCamera.setVisibility(View.GONE);
		...
		if(MediaChooserConstants.showImage){
			...
			//mTabHost.getTabWidget().setBackgroundColor(getResources().getColor(R.color.headerbar_color));
		}
		...
		for (int i = 0; i < mTabHost.getTabWidget().getChildCount(); i++) {
			...
			//ImageView imageView = (ImageView) childView.findViewById(android.R.id.background);
               Log.d("111111111", ""+mTabHost.getTabWidget().getChildAt(i));
			//mTabHost.getTabWidget().getChildAt(i).setBackgroundColor(R.color.imageborder); 
