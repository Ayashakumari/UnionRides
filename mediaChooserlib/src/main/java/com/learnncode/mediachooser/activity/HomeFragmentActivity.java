...
@SuppressLint("ResourceAsColor") public class HomeFragmentActivity extends FragmentActivity implements ImageFragment.OnImageSelectedListener, 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for (int i = 0; i < mTabHost.getTabWidget().getChildCount(); i++) {
			...
			if(textView.getLayoutParams() instanceof RelativeLayout.LayoutParams){
				mTabHost.getTabWidget().getChildAt(mTabHost.getCurrentTab()).setBackgroundColor(getResources().getColor(R.color.tabs_color));
				...
				mTabHost.getTabWidget().getChildAt(mTabHost.getCurrentTab()).setBackgroundColor(R.color.tabs_color);
				LinearLayout.LayoutParams params = (android.widget.LinearLayout.LayoutParams) textView.getLayoutParams();
				params.gravity = Gravity.CENTER;
				textView.setLayoutParams(params);
			}

		//	mTabHost.getTabWidget().getChildAt(1).setBackgroundColor(getResources().getColor(R.color.tabs_title_color));
