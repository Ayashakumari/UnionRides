...
public class CropImageViewRide extends ImageViewTouchBase {
    ...
    public CropImageViewRide(Context context) {
        super(context);
    }

    public CropImageViewRide(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CropImageViewRide(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean onTouchEvent(@NonNull MotionEvent event) {
        CropImageActivityRide cropImageActivity = (CropImageActivityRide) context;
