...
public class CropRide {
     ...
     */
    public static CropRide of(Uri source, Uri destination) {
        return new CropRide(source, destination);
    }

    private CropRide(Uri source, Uri destination) {
     ...
     * @param y Aspect Y
     */
    public CropRide withAspect(int x, int y) {
     ...
     */
    public CropRide withMaxSize(int width, int height) {
     ...
     */
    public CropRide asPng(boolean asPng) {
    ...
    public Intent getIntent(Context context) {
        cropIntent.setClass(context, CropImageActivityRide.class);
        return cropIntent;
    }
